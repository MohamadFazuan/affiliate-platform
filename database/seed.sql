...
-- Password: "test_123" for all test users
-- Hash generated using bcrypt-ts with salt rounds=10
INSERT INTO users (id, email, password_hash, role, created_at, subscription_tier, trial_ends_at)
VALUES
('user_001', 'admin@affiliateiq.com', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'admin', strftime('%s', 'now'), 'enterprise', NULL),
('user_002', 'demo@affiliateiq.com', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'affiliate', strftime('%s', 'now'), 'free', strftime('%s', 'now', '+14 days')),
('user_003', 'test@example.com', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'affiliate', strftime('%s', 'now'), 'pro', NULL);

-- Sample products with realistic affiliate data
...
-- Note: potential_score calculated as: (commission * avg_monthly_sales * conversion_rate * price / 100) - (competition_factor * 100) + trend_score - (refund_rate * 500)
-- Competition factors: Low=1, Medium=2, High=3
